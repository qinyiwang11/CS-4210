...
# SPECIFICATION: association rule mining on supermarket products
...
# To make use of the apriori module given by mlxtend library, we need to convert the dataset accordingly
...
for i, rule in rules.iterrows():
    ...
    # To calculate the prior and gain in confidence, find in how many transactions the consequent of the rule appears (the supporCount below)
    # Then,use the gain formula provided right after
